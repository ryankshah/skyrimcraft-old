...
public class steve extends EntityModel<Entity> {
	...
	public steve() {
		...
		Ear_Left.setTextureOffset(4, 13).addBox(5.0F, 18.0F, -1.0F, 1.0F, 1.0F, 2.0F, 0.0F, false);
		...
		Ear_Right.setTextureOffset(4, 13).addBox(3.0F, 18.0F, -1.0F, 1.0F, 1.0F, 2.0F, 0.0F, false);
	}

...
public class ModRecipes extends RecipeProvider implements IConditionBuilder
{
    ...
    protected void buildShapelessRecipes(Consumer<IFinishedRecipe> consumer) {
        ...
        CookingRecipeBuilder.blasting(Ingredient.of(ModBlocks.MOONSTONE_ORE_ITEM.get()), ModItems.MOONSTONE_INGOT.get(), 0.7F, 100).unlockedBy("has_moonstone_ore", has(ModBlocks.MOONSTONE_ORE_ITEM.get())).save(consumer, Skyrimcraft.MODID+":blasting/moonstone_ingot_from_blasting");
        CookingRecipeBuilder.blasting(Ingredient.of(ModBlocks.ORICHALCUM_ORE_ITEM.get()), ModItems.ORICHALCUM_INGOT.get(), 0.7F, 100).unlockedBy("has_orichalcum_ore", has(ModBlocks.ORICHALCUM_ORE_ITEM.get())).save(consumer, Skyrimcraft.MODID+":blasting/orichalcum_ingot_from_blasting");
    }

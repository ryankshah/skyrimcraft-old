...
public class ModStructures {
     ...
     */
    public static final DeferredRegister<StructureFeature<?>> STRUCTURES = DeferredRegister.create(ForgeRegistries.STRUCTURE_FEATURES, Skyrimcraft.MODID);
     ...
     */
    public static final RegistryObject<StructureFeature<JigsawConfiguration>> SHOUT_WALL = STRUCTURES.register("shout_wall", () -> (new StructureShoutWall(JigsawConfiguration.CODEC)));
    ...
    public static void setupStructures() {
        setupMapSpacingAndLand(
                SHOUT_WALL.get(), /* The instance of the structure */
                new StructureFeatureConfiguration(20 /* average distance apart in chunks between spawn attempts */,
                        ...
                        99482124 /* this modifies the seed of the structure so no two structures always spawn over each-other. Make this large and unique. */),
                true);

...
public class ModStructures {
     ...
     */
    public static final DeferredRegister<Structure<?>> STRUCTURES = DeferredRegister.create(ForgeRegistries.STRUCTURE_FEATURES, Skyrimcraft.MODID);
     ...
     */
    public static final RegistryObject<Structure<NoFeatureConfig>> SHOUT_WALL = STRUCTURES.register("shout_wall", () -> (new StructureShoutWall(NoFeatureConfig.CODEC)));

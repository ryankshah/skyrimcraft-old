...
public class ModConfiguredStructures {
     ...
     */
    public static StructureFeature<?, ?> CONFIGURED_SHOUT_WALL = ModStructures.SHOUT_WALL.get().configured(IFeatureConfig.NONE);
    ...
    public static void registerConfiguredStructures() {
         ...
         */
        FlatGenerationSettings.STRUCTURE_FEATURES.put(ModStructures.SHOUT_WALL.get(), CONFIGURED_SHOUT_WALL);
    }
}
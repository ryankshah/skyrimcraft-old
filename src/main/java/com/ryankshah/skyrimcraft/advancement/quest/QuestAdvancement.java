package com.ryankshah.skyrimcraft.advancement.quest;

public class QuestAdvancement {}//extends Advancement
//{
//    @Nullable
...
//
//    public Advancement(QuestAdvancement p_138307_, @Nullable Advancement p_138308_, @Nullable DisplayInfo p_138309_, AdvancementRewards p_138310_, Map<String, Criterion> p_138311_, String[][] p_138312_) {
//        this.id = p_138307_;
...
//    }
//
//    public QuestAdvancement.Builder deconstruct() {
//        return new QuestAdvancement.Builder(this.parent == null ? null : this.parent.getId(), this.display, this.rewards, this.criteria, this.requirements);
//    }
//
//    @Nullable
//    public net.minecraft.advancements.Advancement getParent() {
//        return this.parent;
//    }
//
//    @Nullable
...
//    }
//
//    public Iterable<net.minecraft.advancements.Advancement> getChildren() {
...
//    }
//
//    public void addChild(net.minecraft.advancements.Advancement p_138318_) {
...
//        if (this == p_138324_) {
//            return true;
//        } else if (!(p_138324_ instanceof net.minecraft.advancements.Advancement)) {
//            return false;
//        } else {
//            net.minecraft.advancements.Advancement advancement = (net.minecraft.advancements.Advancement)p_138324_;
...
//        @Nullable
//        private net.minecraft.advancements.Advancement parent;
//        @Nullable
...
//        }
//
//        public net.minecraft.advancements.Advancement.Builder parent(net.minecraft.advancements.Advancement p_138399_) {
//            this.parent = p_138399_;
//            return this;
//        }
//
//        public net.minecraft.advancements.Advancement.Builder parent(ResourceLocation p_138397_) {
//            this.parentId = p_138397_;
//            return this;
//        }
//
//        public net.minecraft.advancements.Advancement.Builder display(ItemStack p_138363_, Component p_138364_, Component p_138365_, @Nullable ResourceLocation p_138366_, FrameType p_138367_, boolean p_138368_, boolean p_138369_, boolean p_138370_) {
//            return this.display(new DisplayInfo(p_138363_, p_138364_, p_138365_, p_138366_, p_138367_, p_138368_, p_138369_, p_138370_));
//        }
//
//        public net.minecraft.advancements.Advancement.Builder display(ItemLike p_138372_, Component p_138373_, Component p_138374_, @Nullable ResourceLocation p_138375_, FrameType p_138376_, boolean p_138377_, boolean p_138378_, boolean p_138379_) {
...
//        }
//
//        public net.minecraft.advancements.Advancement.Builder display(DisplayInfo p_138359_) {
//            this.display = p_138359_;
//            return this;
//        }
//
//        public net.minecraft.advancements.Advancement.Builder rewards(AdvancementRewards.Builder p_138355_) {
//            return this.rewards(p_138355_.build());
//        }
//
//        public net.minecraft.advancements.Advancement.Builder rewards(AdvancementRewards p_138357_) {
//            this.rewards = p_138357_;
//            return this;
//        }
//
//        public net.minecraft.advancements.Advancement.Builder addCriterion(String p_138387_, CriterionTriggerInstance p_138388_) {
//            return this.addCriterion(p_138387_, new Criterion(p_138388_));
//        }
//
//        public net.minecraft.advancements.Advancement.Builder addCriterion(String p_138384_, Criterion p_138385_) {
...
//        }
//
//        public net.minecraft.advancements.Advancement.Builder requirements(RequirementsStrategy p_138361_) {
//            this.requirementsStrategy = p_138361_;
//            return this;
//        }
//
//        public net.minecraft.advancements.Advancement.Builder requirements(String[][] p_143952_) {
//            this.requirements = p_143952_;
//            return this;
//        }
//
//        public boolean canBuild(Function<ResourceLocation, net.minecraft.advancements.Advancement> p_138393_) {
...
//        }
//
//        public net.minecraft.advancements.Advancement build(ResourceLocation p_138404_) {
...
//                }
//
//                return new net.minecraft.advancements.Advancement(p_138404_, this.parent, this.display, this.rewards, this.criteria, this.requirements);
//            }
//        }
//
//        public net.minecraft.advancements.Advancement save(Consumer<net.minecraft.advancements.Advancement> p_138390_, String p_138391_) {
//            net.minecraft.advancements.Advancement advancement = this.build(new ResourceLocation(p_138391_));
...
//        @Deprecated
//        public static net.minecraft.advancements.Advancement.Builder fromJson(JsonObject p_138381_, DeserializationContext p_138382_) {
//            return fromJson(p_138381_, p_138382_, net.minecraftforge.common.crafting.conditions.ICondition.IContext.EMPTY);
//        }
//
//        public static net.minecraft.advancements.Advancement.Builder fromJson(JsonObject p_138381_, DeserializationContext p_138382_, net.minecraftforge.common.crafting.conditions.ICondition.IContext context) {
...
//                }
//
//                return new net.minecraft.advancements.Advancement.Builder(resourcelocation, displayinfo, advancementrewards, map, astring);
//            }
//        }
//
//        public static net.minecraft.advancements.Advancement.Builder fromNetwork(FriendlyByteBuf p_138402_) {
...
//            }
//
//            return new net.minecraft.advancements.Advancement.Builder(resourcelocation, displayinfo, AdvancementRewards.EMPTY, map, astring);
//        }
//
//        public Map<String, Criterion> getCriteria() {
//            return this.criteria;

...
public class SpellRegistry
{
     ...
     */
    public static RegistryObject<ISpell> UNRELENTING_FORCE = SPELLS.register("unrelenting_force", () -> new UnrelentingForce(0));

    // Spells
    public static RegistryObject<ISpell> FIREBALL = SPELLS.register("fireball", () -> new SpellFireball(1));
}
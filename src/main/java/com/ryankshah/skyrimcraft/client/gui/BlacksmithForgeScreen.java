...
public class BlacksmithForgeScreen extends Screen
{
    ...
    public BlacksmithForgeScreen(List<ForgeRecipe> recipes) {
        super(new TranslationTextComponent(Skyrimcraft.MODID + ".blacksmithforgegui.title"));
...
//                        continue;
    ...
    private void drawItemImage(MatrixStack matrixStack, ItemStack is, int xPos, int yPos, float spin) {
        ...
        this.itemRenderer.render(is, ItemCameraTransforms.TransformType.GROUND, false, matrixStack, irendertypebuffer$impl, 15728880, OverlayTexture.NO_OVERLAY, this.itemRenderer.getModel(is, minecraft.level, minecraft.player));
    ...
    private void drawItemInformation(MatrixStack matrixStack, ForgeRecipe recipe) {
    ...
    private void renderLevel(MatrixStack matrixStack) {

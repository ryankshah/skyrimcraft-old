...
public class MagicScreen extends Screen
{
    ...
    public MagicScreen(List<ISpell> knownSpells) {
        super(new TranslatableComponent(Skyrimcraft.MODID + ".magicscreen.title"));
    ...
    public void render(PoseStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        if(this.spellTypeChosen) {
            ...
            fillGradient(matrixStack, this.width - 88, 0, this.width - 87, this.height, 0xFF5D5A51, 0xFF5D5A51);
            fillGradient(matrixStack, this.width - 13, 0, this.width - 12, this.height, 0xFF5D5A51, 0xFF5D5A51);
            // Left
            fillGradient(matrixStack, this.width - 190, 0, this.width - 110, this.height, 0xAA222222, 0xAA222222);
            fillGradient(matrixStack, this.width - 188, 0, this.width - 187, this.height, 0xFF6E6B64, 0xFF6E6B64);
            fillGradient(matrixStack, this.width - 113, 0, this.width - 112, this.height, 0xFF6E6B64, 0xFF6E6B64);
        } else {
            // Right
            fillGradient(matrixStack, this.width - 90, 0, this.width - 10, this.height, 0xAA222222, 0xAA222222);
            fillGradient(matrixStack, this.width - 88, 0, this.width - 87, this.height, 0xFF6E6B64, 0xFF6E6B64);
            fillGradient(matrixStack, this.width - 13, 0, this.width - 12, this.height, 0xFF6E6B64, 0xFF6E6B64);
            // Left
            fillGradient(matrixStack, this.width - 190, 0, this.width - 110, this.height, 0xAA000000, 0xAA000000);
            fillGradient(matrixStack, this.width - 188, 0, this.width - 187, this.height, 0xFF5D5A51, 0xFF5D5A51);
            fillGradient(matrixStack, this.width - 113, 0, this.width - 112, this.height, 0xFF5D5A51, 0xFF5D5A51);
        }
        ...
        drawGradientRect(matrixStack, 17, this.height - 29, 32, this.height - 14, 0xAA000000, 0xAA000000, 0xFF6E6B64);
        drawGradientRect(matrixStack, 37, this.height - 29, 52, this.height - 14, 0xAA000000, 0xAA000000, 0xFF6E6B64);
    ...
    private void drawGradientRect(PoseStack matrixStack, int startX, int startY, int endX, int endY, int colorStart, int colorEnd, int borderColor) {
    ...
    private void drawSpellInformation(PoseStack matrixStack, ISpell spell, float partialTicks) {

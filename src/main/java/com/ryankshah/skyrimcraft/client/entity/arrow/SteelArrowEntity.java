...
public class SteelArrowEntity extends AbstractArrowEntity
{
    ...
    public SteelArrowEntity(World world, double p_i46757_2_, double p_i46757_4_, double p_i46757_6_) {
        super(ModEntityType.STEEL_ARROW_ENTITY.get(), p_i46757_2_, p_i46757_4_, p_i46757_6_, world);
    }

    public SteelArrowEntity(World world, LivingEntity livingEntity) {

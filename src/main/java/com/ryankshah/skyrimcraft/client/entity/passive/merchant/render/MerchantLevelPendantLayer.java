...
public class MerchantLevelPendantLayer <T extends LivingEntity & IVillagerDataHolder, M extends EntityModel<T> & IHeadToggle> extends LayerRenderer<T, M> implements IResourceManagerReloadListener {
...
//    });
    ...
    public MerchantLevelPendantLayer(IEntityRenderer<T, M> p_i50955_1_, IReloadableResourceManager p_i50955_2_, String p_i50955_3_) {
        super(p_i50955_1_);
...
//                }
    ...
    private ResourceLocation getResourceLocation(String p_215351_1_, ResourceLocation p_215351_2_) {
        return new ResourceLocation(Skyrimcraft.MODID, "textures/entity/" + this.path + "/" + p_215351_1_ + "/" + p_215351_2_.getPath() + ".png");
    }

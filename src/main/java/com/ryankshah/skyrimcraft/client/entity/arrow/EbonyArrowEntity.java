...
public class EbonyArrowEntity extends AbstractArrow
{
    public EbonyArrowEntity(EntityType<? extends EbonyArrowEntity> entityType, Level world) {
        super(entityType, world);
    }

    public EbonyArrowEntity(Level world, double p_i46757_2_, double p_i46757_4_, double p_i46757_6_) {
        super(ModEntityType.EBONY_ARROW_ENTITY.get(), p_i46757_2_, p_i46757_4_, p_i46757_6_, world);
    }

    public EbonyArrowEntity(Level world, LivingEntity livingEntity) {

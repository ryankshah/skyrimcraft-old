...
public class MonarchButterfly extends PathfinderMob implements IAnimatable
{
    ...
    class WanderGoal extends Goal {
        ...
        public void start() {
            ...
            if (vector3d != null) {
                MonarchButterfly.this.navigation.moveTo(MonarchButterfly.this.navigation.createPath(new BlockPos(vector3d), 1), 1.0D);
            }
    ...
    private <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event) {
        event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.monarchbutterfly.fly", true));

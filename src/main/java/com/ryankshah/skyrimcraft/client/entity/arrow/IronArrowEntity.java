...
{
    public IronArrowEntity(EntityType<? extends IronArrowEntity> entityType, Level world) {
        super(entityType, world);
    }

    public IronArrowEntity(Level world, double p_i46757_2_, double p_i46757_4_, double p_i46757_6_) {
        super(ModEntityType.IRON_ARROW_ENTITY.get(), p_i46757_2_, p_i46757_4_, p_i46757_6_, world);
    }

    public IronArrowEntity(Level world, LivingEntity livingEntity) {

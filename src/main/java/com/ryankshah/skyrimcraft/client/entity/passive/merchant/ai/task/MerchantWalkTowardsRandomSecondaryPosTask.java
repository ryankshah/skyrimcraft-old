...
public class MerchantWalkTowardsRandomSecondaryPosTask extends Task<MerchantEntity>
{
    ...
    public MerchantWalkTowardsRandomSecondaryPosTask(MemoryModuleType<List<GlobalPos>> p_i50340_1_, float p_i50340_2_, int p_i50340_3_, int p_i50340_4_, MemoryModuleType<GlobalPos> p_i50340_5_) {

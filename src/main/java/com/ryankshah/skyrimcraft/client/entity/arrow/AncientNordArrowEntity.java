...
public class AncientNordArrowEntity extends AbstractArrowEntity
{
    public AncientNordArrowEntity(EntityType<? extends AncientNordArrowEntity> entityType, World world) {
        super(entityType, world);
    }

    public AncientNordArrowEntity(World world, double p_i46757_2_, double p_i46757_4_, double p_i46757_6_) {
        super(ModEntityType.ANCIENT_NORD_ARROW_ENTITY.get(), p_i46757_2_, p_i46757_4_, p_i46757_6_, world);
    }

    public AncientNordArrowEntity(World world, LivingEntity livingEntity) {

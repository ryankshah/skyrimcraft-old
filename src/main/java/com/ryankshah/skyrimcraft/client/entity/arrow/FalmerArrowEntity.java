...
public class FalmerArrowEntity extends AbstractArrowEntity
{
    public FalmerArrowEntity(EntityType<? extends FalmerArrowEntity> entityType, World world) {
        super(entityType, world);
    }

    public FalmerArrowEntity(World world, double p_i46757_2_, double p_i46757_4_, double p_i46757_6_) {
        super(ModEntityType.FALMER_ARROW_ENTITY.get(), p_i46757_2_, p_i46757_4_, p_i46757_6_, world);
    }

    public FalmerArrowEntity(World world, LivingEntity livingEntity) {

...
public class DaedricArrowEntity extends AbstractArrowEntity
{
    public DaedricArrowEntity(EntityType<? extends DaedricArrowEntity> entityType, World world) {
        super(entityType, world);
    }

    public DaedricArrowEntity(World world, double p_i46757_2_, double p_i46757_4_, double p_i46757_6_) {
        super(ModEntityType.DAEDRIC_ARROW_ENTITY.get(), p_i46757_2_, p_i46757_4_, p_i46757_6_, world);
    }

    public DaedricArrowEntity(World world, LivingEntity livingEntity) {

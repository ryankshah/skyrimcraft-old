...
public class ModBlocks
{
    ...
    public static final RegistryObject<Item> RED_MOUNTAIN_FLOWER_ITEM = BLOCK_ITEMS.register("red_mountain_flower", () -> new SkyrimBlockItem(ModBlocks.RED_MOUNTAIN_FLOWER.get(), new Item.Properties().tab(Skyrimcraft.TAB_INGREDIENTS), "Red Mountain Flower"));

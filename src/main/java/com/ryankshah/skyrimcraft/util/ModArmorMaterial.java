...
{
    ANCIENT_NORD("ancient_nord", 15, new int[]{1, 4, 5, 2}, 12, SoundEvents.ARMOR_EQUIP_CHAIN, 0.0F, 0.0F, () -> {
        return Ingredient.of(Items.IRON_INGOT);
    }),
    GLASS("glass", 37, new int[]{2, 5, 6, 2}, 9, SoundEvents.GLASS_PLACE, 3.0F, 0.1F, () -> {
        return Ingredient.of(ModItems.MALACHITE_INGOT.get());
    }),
    DAEDRIC("daedric", 37, new int[]{3, 6, 8, 3}, 15, SoundEvents.ARMOR_EQUIP_NETHERITE, 3.0F, 0.1F, () -> {
